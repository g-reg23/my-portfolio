...
const DevOps = () => {
  ...
  'DigitalOcean is a cloud based hosting service. I have experience configuring digitalocean droplets. Utilizing linux skills I have set up multiple servers to serve production web applications. Experience using pm2 as a process manager to run a node server. I am also experienced in setting up an nginx server to serve both static assets and route api requests to the server on the same droplet.']
  return (
    <div>
