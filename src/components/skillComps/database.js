...
const Database = () => {
  ...
  'MongoDB is a NoSQL database system which stores data in a JSON-like form. MongoDB and Mongoose ODM were the perfect choice for building YessNo.co, my yes/no voting app. Dealing with JSON objects makes it a perfect fit for working with node and Express on the back-end, and react and javascript on the front-end. MongoDB gave me the ability to continuously develop more complex models for votes and voters throughout development based on its flexibility and ability to work well with objects. For YessNo I used MongoDB Atlas, an AWS cloud based database service.']
  return (
    <div>
