...
const Frontend = () => {
  ...
  'React is a javascript framework to help build user interfaces in single page applications. I have over 1 year experience working with React and the React ecosystem. I have experience experience working with both class based components as well as functional components, I am well versed with the hooks API. Among some of the many great react libraries I am familiar with are react-router, react-spring, react-strap, trophy, and react-visibility-sensor',
