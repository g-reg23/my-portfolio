...
function Skills() {
  ...
  'Python is a general purpose programming language. Python can be used for many things including web development, machine learning, and data science. I have experience using Python to build web , namely with Flask. Python is one of my first languages (right after C), I have taken multiple online Python courses, therefore I have some foundation in data science as well.']
